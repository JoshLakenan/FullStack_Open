...
const Notification = ({ text }) => {
  return (
    <p>A new anecdote: <strong>{text}</strong> has been added</p>
  )
}
...
const inputResetWrapper = (...resetFuncArr) => {
  const reset = (e) => {
    e.preventDefault()
    for (let func of resetFuncArr) {
      func()
    }
  }
...
const CreateNew = ({ addNew }) => {
  ...
  const reset = inputResetWrapper(cReset, aReset, iReset)
...
const App = () => {
  ...
  return (
    <div>
      ...
      {notification ? <Notification text={notification}/> : null}
